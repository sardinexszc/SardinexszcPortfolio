...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $timeline = [
            ...
            ['type' => 'experience', 'organization' => 'Central Luzon State University', 'role' => 'Researcher, Instructor, and Information Systems Developer', 'description' => 'Developed research information systems, IoT monitoring platforms, content management systems, and smart agriculture applications while teaching Information Technology.', 'start_date' => '2019', 'end_date' => '2026'],
            ['type' => 'experience', 'organization' => 'Central Luzon State University', 'role' => 'Project Technical Staff', 'description' => 'Handled administrative and ICT responsibilities supporting institutional operations and project execution.', 'start_date' => '2017', 'end_date' => '2019'],
